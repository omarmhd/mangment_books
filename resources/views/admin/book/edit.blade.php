        ...
        <div class="col-md-9 ">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    @endif
                    <form role="form" action="{{route('book.update',['book'=>$book->id])}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        @method('PUT')
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input has-success form-md-floating-label">
                                        <div class="input-icon">
                                            <input type="text" class="form-control" name="published_by" value="{{$book->published_by}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input has-success form-md-floating-label">
                                        <div class="input-icon">
                                            <input type="number"  min="0" class="form-control" value="{{$book->number_pages}}" name="number_pages">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input has-success form-md-floating-label">
                                        <div class="input-icon">
                                            <input type="text" class="form-control" name="publish_year" min="0" pattern="\d*" maxlength="4" value="{{$book->publish_year}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input has-success form-md-floating-label delivery_date">
                                        <div class="input-icon">
                                            <input type="date" class="form-control" name="delivery_date" value="{{$book->delivery_date}}">
                            ...
                            <div class="form-group form-md-radios">
                                ...
                                <div class="md-radio-inline">
                                    <div class="md-radio">
                                        <input type="radio" {{$book->type_delivery=='Electronic'?'checked':''}} value="Electronic" id="radio6" onclick="myFunction()" name="type_delivery" class="md-radiobtn" >
                                    ...
                                    <div class="md-radio">
                                        <input type="radio" {{$book->type_delivery=='Hard'?'checked':''}}  value="Hard" id="radio7" name="type_delivery" class="md-radiobtn" >
